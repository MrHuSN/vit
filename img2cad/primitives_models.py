...
from img2cad import dataset, modules, _lightning
...
@dataclasses.dataclass
class RawPrimitiveTrainingConfig(_lightning.TrainingConfiguration):
...
@dataclasses.dataclass
class ImagePrimitiveTrainingConfig(_lightning.TrainingConfiguration):
